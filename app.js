const translations = {
  "en": {
    ...
    "about_6": "I know the difference between using AI and depending on it. My expertise is 20+ years of practice, not copy-paste from ChatGPT.",
  ...
  "ru": {
    ...
    "about_6": "Знаю разницу между использованием ИИ и зависимостью от него. Моя экспертиза - более 20 лет практики, а не копипаст из ChatGPT.",
    "exp_seo": "лет в SEO",
    "exp_modx": "лет с MODX",
  ...
  "uk": {
    ...
    "about_6": "Знаю різницю між використанням ШІ та залежністю від нього. Моя експертиза - понад 20 років практики, а не копіпаст з ChatGPT.",
    "exp_seo": "років у SEO",
